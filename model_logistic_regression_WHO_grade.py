...
def baseline_logistic_model(data, target_col="resistant"):
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, "Logistic_Regression_random_split_WHO.png"), dpi=300)
    plt.close()
...
def drug_holdout_logistic_model(data, drug_lookup, target_col="resistant"):
    print(f"Running Logistic Regression testing 3 unseen drugs  ...")
    ...
    # save the file as a png
    plt.savefig(os.path.join(OUTPUT_DIR, "Logistic_Regression_Drug_holdout_WHO.png"), dpi=300)
    plt.close()
...
def PCA_logistic_model(data, drug_lookup, target_col="resistant"):
    print(f"Running Logistic Regression with PCA testing 3 unseen drugs  ......")
    ...
    # save the file as a png
    plt.savefig(os.path.join(OUTPUT_DIR, "PCA_Logistic_Regression_WHO.png"), dpi=300)
    plt.close()
